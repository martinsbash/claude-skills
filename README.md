...
1. Type "learn from this mistake" or "don't make that error again" → self-evolving-agent kicks in
2. Type "compact this chat" or "context is getting long" → chat-compactor runs
3. Type "continue from last session" or "pick up where we left off (mention the particular chat name/title)" → session-continuity restores context
4. Type "research this" or "verify this claim" → oracle-research runs a sourced investigation
